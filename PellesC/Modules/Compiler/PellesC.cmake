...
macro(__compiler_pellesc lang)
  ...
  set(CMAKE_${lang}_CREATE_SHARED_LIBRARY "<CMAKE_LINKER> -out:<TARGET> -IMPLIB:<TARGET_IMPLIB> <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> -dll")
  set(CMAKE_${lang}_LINK_EXECUTABLE "<CMAKE_LINKER> -out:<TARGET> <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES>")

  set(CMAKE_LIBRARY_PATH_FLAG " -libpath")  # TODO ??
  set(CMAKE_SHARED_LIBRARY_CREATE_${lang}_FLAGS "-dll")
