...
file(READ "${CMAKE_ROOT}/Modules/${FindBinUtils_module}" fbu)
set(fail 0)
ps_rev_apply_patch("${fbu}" FindBinUtils fbu_n fail)
ps_rev_apply_patch("${adm}" DetermineASM1 adm_n fail)
ps_rev_apply_patch("${adm_n}" DetermineASM adm_n fail)
...
ps_save("${CMAKE_ROOT}/Modules/${FindBinUtils_module}" "pre-uninstall" "${fbu_n}")
